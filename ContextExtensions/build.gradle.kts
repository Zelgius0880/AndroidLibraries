...
val publish = rootProject.extra.get("publish") as (p: Project, sourceSet: Set<File>, variant: org.gradle.api.internal.DefaultDomainObjectSet<LibraryVariant>, classPath: FileCollection ) -> Unit
